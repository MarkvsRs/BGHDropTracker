...
reader.readargs = {
    colors: [
        ...
        _alt1_base__WEBPACK_IMPORTED_MODULE_0__.mixColor(163, 53, 238), //purple drops
    ]
};
...
function buildTable() {
    for (const x in compsList) {
        if (compsList[x].type === "rare") {
            jquery__WEBPACK_IMPORTED_MODULE_2__(".rare").append(`<tr data-name="${x}"><td>${x}</td><td class='qty'></td></tr>`);
        }
        if (compsList[x].type === "eggs") {
            jquery__WEBPACK_IMPORTED_MODULE_2__(".eggs").append(`<tr data-name="${x}"><td>${x}</td><td class='qty'></td></tr>`);
        }
        if (compsList[x].type === "common") {
            jquery__WEBPACK_IMPORTED_MODULE_2__(".common").append(`<tr data-name="${x}"><td>${x}</td><td class='qty'></td></tr>`);
        }
    }
}
function tidyTable() {
    ...
    for (const x in compsList) {
        ...
        if (compsList[x].qty === 0) {
            jquery__WEBPACK_IMPORTED_MODULE_2__(`[data-name='${x}']`).hide();
        }
        else {
            jquery__WEBPACK_IMPORTED_MODULE_2__(`[data-name='${x}']`).show();
        }
    }
    jquery__WEBPACK_IMPORTED_MODULE_2__(`[data-name='${mats}']`)
        .css({ "background-color": "lime" })
        .animate({
        backgroundColor: ("rgba(0, 0, 0, 0)"),
    }, 500, function () {
        jquery__WEBPACK_IMPORTED_MODULE_2__(this).removeAttr("style");
    });
...
jquery__WEBPACK_IMPORTED_MODULE_2__(".edit").change(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_2__(this).is(":checked")) {
        if (jquery__WEBPACK_IMPORTED_MODULE_2__(".tracker").text() == "Stop") {
            jquery__WEBPACK_IMPORTED_MODULE_2__(".tracker").click();
        }
        jquery__WEBPACK_IMPORTED_MODULE_2__("tr:hidden").show();
        jquery__WEBPACK_IMPORTED_MODULE_2__(".qty")
        ...
        jquery__WEBPACK_IMPORTED_MODULE_2__(".qty").removeAttr("contenteditable");
        for (const x in compsList) {
...
jquery__WEBPACK_IMPORTED_MODULE_2__("button.tracker")
    .click(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_2__(this).html() == "Start") {
        console.log("Starting tracker");
        var tracking = setInterval(function () {
            readChatbox();
        }, 600);
        jquery__WEBPACK_IMPORTED_MODULE_2__(this).html("Stop");
    }
    else {
        console.log("Stopping tracker");
        jquery__WEBPACK_IMPORTED_MODULE_2__(this).html("Start");
        clearInterval(tracking);
    }
})
    .click();
jquery__WEBPACK_IMPORTED_MODULE_2__("button.clear").click(function () {
...
jquery__WEBPACK_IMPORTED_MODULE_2__(".toggleMenu").click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_2__(".options").toggle();
});
jquery__WEBPACK_IMPORTED_MODULE_2__(".export").click(function () {
...
jquery__WEBPACK_IMPORTED_MODULE_2__(".chat").change(function () {
    reader.pos.mainbox = reader.pos.boxes[jquery__WEBPACK_IMPORTED_MODULE_2__(this).val()];
    showSelectedChat(reader.pos);
    localStorage.setItem("ccChat", jquery__WEBPACK_IMPORTED_MODULE_2__(this).val());
